...
* **Ruby**: [[install ruby API|ruby_install]] - [Ruby API reference](http://rdoc.info/github/AF83/ucengine.rb/master/frames) - [Ruby event-machine librairy](https://github.com/AF83/ucengine.em)
